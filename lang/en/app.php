...
return array (
  ...
  'buttons.choose_icon' => 'Choose icon',
  ...
  'alert.success.icon_created' => 'Icon added to the library',
  'alert.success.icon_updated' => 'Icon renamed successfully',
  'alert.success.icon_deleted' => 'Icon deleted successfully',
  'alert.success.icon_replaced' => 'Icon replaced successfully',
  'icons.library' => 'Icon library',
  'icons.manage' => 'Icons',
  'icons.icon_name' => 'Icon name',
  'icons.icon_name_help' => 'Name used to find this icon later.',
  'icons.size' => 'Size',
  'icons.added' => 'Added',
  'icons.replace' => 'Replace file',
  'icons.in_use' => 'Used by :count item(s) - deletion is disabled, replace the file instead.',
  'icons.confirm_delete' => 'Delete this icon?',
  'icons.no_icons' => 'No icons in the library yet',
  'icons.invalid_image' => 'The icon must be a valid image (jpg, jpeg, png, bmp, gif, svg, webp, ico).',
  'icons.malicious_svg' => 'SVG contains malicious content and cannot be uploaded.',
