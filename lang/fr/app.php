...
return array (
  ...
  'buttons.choose_icon' => 'Choisir une icône',
  ...
  'alert.success.icon_created' => 'Icône ajoutée à la bibliothèque',
  'alert.success.icon_updated' => 'Icône renommée avec succès',
  'alert.success.icon_deleted' => 'Icône supprimée avec succès',
  'alert.success.icon_replaced' => 'Icône remplacée avec succès',
  'icons.library' => 'Bibliothèque d\'icônes',
  'icons.manage' => 'Icônes',
  'icons.icon_name' => 'Nom de l\'icône',
  'icons.icon_name_help' => 'Nom utilisé pour retrouver cette icône plus tard.',
  'icons.size' => 'Taille',
  'icons.added' => 'Ajoutée',
  'icons.replace' => 'Remplacer le fichier',
  'icons.in_use' => 'Utilisée par :count élément(s) - suppression impossible, remplacez le fichier à la place.',
  'icons.confirm_delete' => 'Supprimer cette icône ?',
  'icons.no_icons' => 'Aucune icône dans la bibliothèque',
  'icons.invalid_image' => 'L\'icône doit être une image valide (jpg, jpeg, png, bmp, gif, svg, webp, ico).',
  'icons.malicious_svg' => 'Le SVG contient du contenu malveillant et ne peut pas être téléversé.',
